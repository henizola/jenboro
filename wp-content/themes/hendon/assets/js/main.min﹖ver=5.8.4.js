		...
		v = {
			...
			getOptions: function (e) {
				...
				n = {
					...
					centeredSlides: o,
					spaceBetween: t,
					autoplay: (d = !1 !== d ? { delay: s, disableOnInteraction: !1 } : d),
					loop: a,
					speed: r,
					navigation: { nextEl: h, prevEl: u },
					pagination: { el: g, type: "bullets", clickable: !0 },
					breakpoints: {
						0: {
							slidesPerView:
				...
				return (
					...
					Object.assign(n, v.getSliderDatas(e))
				);
			},
						...
						init: function () {
							e.addClass("qodef-swiper--initialized"),
								e
									...
									.append(
										'<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="74px" height="40px" viewBox="0 0 74 40" enable-background="new 0 0 74 40" xml:space="preserve"><g><circle opacity="0.5" fill="none" stroke="#fcb040" cx="71%" cy="50%" r="24%" style=""></circle><circle fill="none" stroke="#fcb040" cx="71%" cy="50%" r="24%"></circle></g><polygon fill="#fcb040" points="49.525,14.265 48.898,15.044 54.481,19.541 6.444,19.541 6.444,20.541 54.464,20.541 48.901,24.954 49.522,25.737 56.7,20.044 "></polygon></svg>'
									),
								e
									.parent()
			...
			isTargetInView: function (e) {
				...
				return !(
					Math.floor(100 - ((0 <= i.top ? 0 : i.top) / -+i.height) * 100) <
						20 || Math.floor(100 - ((i.bottom - e) / i.height) * 100) < 20
				);
			},
		...
		var d = {
			...
			changeStandardState: function (e, i, t) {
				...
				e.hasClass("qodef-pagination-type--standard") &&
					...
					(e = o.children(".qodef--prev")),
					(o = o.children(".qodef--next")),
					n
